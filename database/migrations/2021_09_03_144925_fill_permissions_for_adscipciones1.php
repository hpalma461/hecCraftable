...
class FillPermissionsForAdscipciones1 extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAdscipciones1 constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.adscipciones1',
            'admin.adscipciones1.index',
            'admin.adscipciones1.create',
            'admin.adscipciones1.show',
            'admin.adscipciones1.edit',
            'admin.adscipciones1.delete',
            'admin.adscipciones1.bulk-delete',
        ]);

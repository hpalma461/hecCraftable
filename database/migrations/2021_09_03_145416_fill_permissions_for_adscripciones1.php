...
class FillPermissionsForAdscripciones1 extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAdscripciones1 constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.adscripciones1',
            'admin.adscripciones1.index',
            'admin.adscripciones1.create',
            'admin.adscripciones1.show',
            'admin.adscripciones1.edit',
            'admin.adscripciones1.delete',
            'admin.adscripciones1.bulk-delete',
        ]);

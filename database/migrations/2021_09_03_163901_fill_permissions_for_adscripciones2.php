...
class FillPermissionsForAdscripciones2 extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAdscripciones2 constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.adscripciones2',
            'admin.adscripciones2.index',
            'admin.adscripciones2.create',
            'admin.adscripciones2.show',
            'admin.adscripciones2.edit',
            'admin.adscripciones2.delete',
            'admin.adscripciones2.bulk-delete',
        ]);
